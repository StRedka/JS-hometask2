...
function evenFn(n) {
  var arr = [];
  var i = 1;
  for (i; i <= n; ++i) if (i % 2 === 0) arr.push(i);
  return arr;
}
...
console.log (`35 :`, ageClassification(35));
console.log (`56 :`, ageClassification(56));
console.log (`66.6 :`, ageClassification(66.6));
console.log (`82 :`, ageClassification(82));
